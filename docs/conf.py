...
try:
    ...
    version = safezip.__version__
    project = safezip.__title__
    copyright = safezip.__copyright__
    author = safezip.__author__
except ImportError:
    version = "0.1"
    project = "safezip"
...
epub_identifier = "https://github.com/barseghyanartur/safezip"  # URL or ISBN
epub_scheme = "URL"  # or "ISBN"
epub_uid = "https://github.com/barseghyanartur/safezip"
