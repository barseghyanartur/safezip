...
Supported Versions
------------------
The two most recent ``safezip`` minor release series receive security
support.
...
.. note::
    ...
    of ``safezip`` 0.17.x, support will be provided
    for ``safezip`` 0.16.x.

    Upon the release of ``safezip`` 0.18.x, security support
    for ``safezip`` 0.16.x will end.
